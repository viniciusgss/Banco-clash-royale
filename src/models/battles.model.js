...
const BattleSchema = new mongoose.Schema({
  ...
  opponent: { type: mongoose.Schema.Types.ObjectId, ref: 'Player', required: true },
  playerDeck: { type: mongoose.Schema.Types.ObjectId, ref: 'BattleDeck', required: true },
  opponentDeck: { type: mongoose.Schema.Types.ObjectId, ref: 'BattleDeck', required: true },
